...
const translations: Record<string, Record<Language, string>> = {
  ...
  passwordPlaceholder: { en: "e.g., *********", ar: "مثال: *********" },
  ...
  avatarUrl: { en: "Avatar URL", ar: "رابط الصورة الرمزية" },
  avatarHint: { en: "Avatar Description (for AI)", ar: "وصف الصورة الرمزية (للذكاء الاصطناعي)" },
